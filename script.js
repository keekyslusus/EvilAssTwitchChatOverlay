...
function addMessage(displayName, color, message, emotes, badges) {
...
client.on('message', (channel, tags, message, self) => {
    ...
    playMessageSound();
    addMessage(displayName, tags.color, message, tags.emotes, tags.badges);
});
